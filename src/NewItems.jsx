...
function NewItemModal({ closeModal, isOpen, itemData, barcodeData }) {
  ...
  useEffect(() => {
    const itemWithRetail = barcodeData.find(
      (obj) =>
        obj["Item No."] === itemNum && obj["Description"].includes("RETAIL")
    );
    console.log(itemWithRetail);
    const itemWithoutRetail = barcodeData.find(
      (obj) =>
        obj["Item No."] === itemNum && !obj["Description"].includes("RETAIL")
    );
    console.log(itemWithoutRetail);
      ...
      <form action="">
        ...
        <div>
          ...
          <input
            ...
            name="salesToRetail"
            value={salesToRetail}
            onChange={(e) => setSalesToRetail(e.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            name="barcodeRetail"
            value={barcodeRetail}
            onChange={(e) => setBarcodeRetail(e.target.value)}
          />
        </div>
        <div>
          ...
          <input
            ...
            value={barcodeNotRetail}
            onChange={(e) => setBarcodeNotRetail(e.target.value)}
          />
        </div>
        <div>
